...
const About = () => {
  return (
    ...
    >
      <VStack alignSelf='center' px="10" textAlign="justify" w={["100%", "100%", "80%", "50%"]} transform={[ 'none', 'none', 'none', 'translate(-60px, 0%)' ]}>
        ...
        <Text fontSize={["sm", "md", "lg"]} color="red.500">
          ...
          leo quis enim congue convallis. Orci varius natoque penatibus et
